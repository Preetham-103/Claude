...
Explain microservices in simple terms with a real-world analogy.
```
## 🔑 Key Takeaway
Adding context transforms a generic request into a precise, tailored instruction that produces richer and more relevant outputs.
